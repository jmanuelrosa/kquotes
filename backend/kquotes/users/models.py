...
class User(AbstractBaseUser, PermissionsMixin):
    ...
    default_language = models.CharField(null=False, blank=True, max_length=20, default="",
                                        verbose_name=_("default language"))
    default_timezone = models.CharField(null=False, blank=True, max_length=20, default="",
